...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Scrolling skills/tags at bottom - Full Width */}
      <div className="relative overflow-hidden py-8 bg-gradient-to-r from-transparent via-white/5 to-transparent w-full">
        <div className="flex animate-scroll">
          {skills.map((skill, index) => (
            <span
              key={index}
              className="text-white/40 text-lg font-medium px-4 whitespace-nowrap"
            >
              {skill}
            </span>
          ))}
